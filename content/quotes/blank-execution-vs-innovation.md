+++
date = '2026-01-07T21:42:31-05:00'
draft = false
title = 'Blank Execution vs Innovation'
quote = "Execution pays your salary; innovation pays your pension."
...
The power of the exponent really shows up in compounding. I heard a ~30 minute speech from Charlie Munger that reinforced some of the insights from "[The Psychology of Money](https://amzn.to/49kYlPH)" (which I also highly recommend) but that was really just "[Don't interrupt compounding](https://www.dwassetmgmt.com/blog/the-first-rule-of-compounding-never-interrupt-it-unnecessarily---charlie-munger)". Our brains are wired to "linear" but compounding is "exponential" -- one of the positive exponentials available to us. It's part of why I've harped on investing with my daughter. She has the advantage of time for that compounding to occur that I just won't. (Assuming we don't all die of global thermonuclear war, or other lesser disasters between now and then!)

Habits are another "compound" area. James Clear's "[Atomic Habits](https://amzn.to/4q7Qxq9)" talks about the difference between getting 1% better every day vs 1% worse. 1% worse, you wind up asymptotically approaching zero (of course). 1% better and by the end of 1 year, you're **37x** your starting point!
